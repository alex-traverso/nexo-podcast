...
const AboutUs = () => {
  return (
    <div
      id="nosotros"
      className="lg:px-sectionSides mm:px-sectionSidesMobile pt-sectionTop pb-sectionBottom w-full flex justify-center"
    >
      <div className="rounded-xl bg-gradient-to-r from-transparent to-primary p-[2px]">
        <div className="bg-darkGrey overflow-hidden mm:flex mm:flex-col mm:items-center lg:flex lg:flex-row lg:items-center lg:justify-between mm:w-[75vw] lg:w-[60vw] rounded-xl">
          <div className=" mm:w-[70vw] lg:w-[45vw] flex justify-center items-center">
            <Image
              src={nexoSpotlight}
              className="mm:h-[10rem] mm:mt-[2rem] lg:h-[20rem] w-auto object-contain"
            ></Image>
          </div>
