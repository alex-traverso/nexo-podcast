...
import profilePic from "src/images/nexo-spotlight.png";
      ...
      text-gray-800"
        >
          <Link className=" cursor-pointer" href="/">
            <Image
              className="mr-1 mm:h-[45px] lg:h-[50px] w-auto object-contain"
              src={profilePic}
              alt="Logo"
            />
          </Link>
        ...
        >
          ...
          <div className=" mm:mt-4 md:mt-0 mm:mr-9 md:mr-0"></div>
        </ul>
      </div>
      {open ? (
        <div
