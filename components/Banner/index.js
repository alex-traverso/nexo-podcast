  ...
  return (
    <div className="mm:flex mm:flex-col-reverse mm:justify-center mm:items-center bg-darkGrey w-full mt-[5rem] h-[calc(100vh_-_5rem)] flex lg:flex-row lg:items-center lg:justify-center lg:gap-4">
      <div className="text-white mm:w-[90vw] lg:w-[25vw]">
        <h2 className="mm:text-4xl lg:text-6xl font-bold mb-6">
          El podcast de diseño que buscabas
        </h2>
        <p className={`mb-6 text-white ${roboto.className}`}>
          Sumergite en increíbles charlas sobre el diseño. Descubrí nuevas
          perspectivas y conectate con expertos en cada episodio. ¡No te pierdas
      ...
      <Image
        className="mm:w-[80vw] lg:w-[600px] h-auto"
        src={bannerImg}
        alt="Logo"
      />
    </div>
